...
-----END PGP PUBLIC KEY BLOCK-----";
    ...
    fn subdomain_minting() {
        ...
        let parent_id_query_res: RaptornamerNftInfoResponse = from_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
    ...
    fn alias_and_paths_cleared_on_send() {
        ...
        assert_eq!(
            ...
            StdError::NotFound {
                kind: "cw721_base::state::TokenInfo<raptornamer::msg::Metadata>".to_string()
            }
        );
